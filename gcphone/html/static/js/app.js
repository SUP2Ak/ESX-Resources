webpackJsonp([1], [, , , , function(t, e, n) {
    ...
    t.exports = ["Ã  l'instant", ["il y a %s seconde", "il y a %s secondes"],
    ...
    e.default = {
        ...
        data: function() {
            return {
                buttons: [{
                    title: "Appeler une ambulance",
                    eventName: "medic",
                    type: "Je suis dans le coma"
                }, {
                    title: "Retourner à l'hopital",
                    eventName: "RESPAWN"
                }],
                currentSelect: 0,
                ignoreControls: !1
        ...
        data: function() {
            return {
                ...
                callList: [{
                    ...
                    display: "Ambulance",
                    subMenu: [{
                        title: "Appel pour réanimation",
                        eventName: "medic",
                        type: "Une personne est dans le coma"
                    }, {
                        title: "Appel pour des soins",
                        eventName: "medic",
                        type: "J'ai besoin de soins"
                    }]
				}, {
					display: "Taxi",
                    subMenu: [{
                        title: "Taxi pour 1 personne",
                        eventName: "taxi",
                        type: "1 personne"
                    }, {
                        title: "Taxi pour 2 personne",
                        eventName: "taxi",
                        type: "2 personnes"
					}, {
                        title: "Taxi pour 3 personne",
                        eventName: "taxi",
                        type: "3 personnes"
                    }]
				}, {
					display: "Depanneur",
                    subMenu: [{
                        title: "Vehicule en panne",
                        eventName: "tow",
                        type: "Vehicule en panne"
                    }, {
                        title: "Trafic routier",
                        eventName: "tow",
                        type: "Trafic routier important"
					}]
                }]
            }
        },
        methods: {
            onSelect: function(t) {
                ...
                !0 !== this.ignoreControls && (this.ignoreControls = !0, c.a.CreateModal({
                    ...
                    e.ignoreControls = !1, "Retour" !== t.title && r.a.callEvent(t.eventName, t.type)
                }))
            },
        ...
        data: function() {
            return {
                paramList: [{
                    ...
                    icons: "fa-picture-o",
                    title: "Fond d'écran",
                    value: localStorage.background_display || "Rose",
                    ...
                    value: localStorage.coque_display || "Coque Noir",
